...
/**
 * Created by T32E on 17/1/9.
 */

public class FullyLinearManager extends LinearLayoutManager {

    private static final String TAG = FullyLinearManager.class.getSimpleName();

    public FullyLinearManager(Context context) {
        super(context);
    }

    public FullyLinearManager(Context context, int orientation, boolean reverseLayout) {
